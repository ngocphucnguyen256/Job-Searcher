...
export default function ProfileItem(props) {
  ...
  const handleModifySubmit = async (event) => {
        ...
        const postData = async () => {
            const res = await Api.patch(endpoints['educationDetail'](modified.id)
            ,   {
                      ...
                      <Box sx={{ flexGrow: 1 }} component="form" onSubmit={handleModifySubmit}>
                              <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                                  <Grid item xs={2} sm={4} md={4} >
                                      ...
                                      <TextField required name="university_name" className="search" fullWidth id="outlined-search" type="search"
                                          value={modified?.university_name}
                                          onChange={(e) => {
                                              setModified({...modified, university_name: e.target.value})
                                          }}
                                      />
                                  ...
                                  <Grid item xs={2} sm={4} md={4} >
                                      ...
                                      <TextField required name="degree_name" className="search" fullWidth id="outlined-search" type="search"
                                  ...
                                  <Grid item xs={2} sm={4} md={4} >
                                      ...
                                      name="CPA" className="search" fullWidth id="outlined-search"
                                      />
                                      </div>
                                  </Grid>
                                  <Grid item xs={2} sm={4} md={4} >
