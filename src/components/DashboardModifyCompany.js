...
const handleGetProfileDetails = async (profileid) => {
  ...
  const handleSubmit = (event) => {
    ...
    let updateUser = async () => {
      ...
      const res = await Api.patch(endpoints['company-detail'](profileDetailId)
      , formData,
      {
        headers: {
      ...
      if(userModifyData.company_name.lenght!==0 && userModifyData.email.length!==0){
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => {
                      setUserModifyData({...userModifyData, company_name: e.target.value})
                  }}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => {
                      setUserModifyData({...userModifyData, email: e.target.value})
                  }}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => {
                      setUserModifyData({...userModifyData, description: e.target.value})
                  }}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) => {
                      setUserModifyData({...userModifyData, web_url: e.target.value})
                  }}
                />
              </Grid>
              <Grid item xs={12}>
              <TextField
                  ...
                  onChange={(e) => {
                      setUserModifyData({...userModifyData, phone: e.target.value})
                  }}
                />
              </Grid>
                <Grid item xs={12}>
